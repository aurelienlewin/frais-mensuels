...
export function SummaryPanel({ ym }: { ym: YM }) {
  ...
  return (
    <section className="motion-hover motion-pop rounded-3xl border border-white/15 bg-ink-950/60 p-6 shadow-[0_12px_40px_-30px_rgba(0,0,0,0.85)] lg:sticky lg:top-32 lg:max-h-[calc(100dvh-8rem)] lg:overflow-auto">
